...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\GeneratedValue]
    #[ORM\Column]
    #[Groups(['user:read', 'adresse:read', 'client:read', 'element:read', 'prestation:read'])]
    private ?int $id = null;

    #[ORM\Column(length: 255)]
    #[Groups(['user:write', 'user:read', 'adresse:read', 'client:read', 'element:read', 'prestation:read'])]
    private ?string $username = null;

    #[ORM\Column(length: 255)]
    #[Groups(['user:write', 'user:read', 'email:write', 'adresse:read', 'client:read','element:read', 'prestation:read'])]
